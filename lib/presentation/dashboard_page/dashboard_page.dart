...
import 'package:app/core/constants/admin.dart';
...
class DashboardPage extends StatelessWidget {
                            ...
                            children: [
                              ...
                              Align(
                                  ...
                                  child: GestureDetector(
                                      onTap: () {
                                        navigatewithclosecurrentscreen();
                                      },
                                      child: Padding(
                                          padding:
                                              getPadding(left: 16, top: 30),
                                  ...
                                  child: Obx(() => ListView.separated(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return SpecialsItemWidget(model,
                                            onimgclickgoto: onimgclickgoto);
                                      }))),
                              Align(
                                  alignment: Alignment.centerLeft,
                                  child: GestureDetector(
                                      onTap: () {
                                        navigatetocloseallscreen();
                                      },
                                      child: Padding(
                                          padding:
                                              getPadding(left: 16, top: 36),
                              ...
                              Align(
                                  ...
                                  child: GestureDetector(
                                      onTap: () {
                                        navigateandpassconstdata();
                                      },
                                      child: Padding(
                                          padding:
                                              getPadding(left: 16, top: 20),
                              ...
                              Container(
                                  ...
                                  child: Obx(() => ListView.separated(
                                      ...
                                      itemCount: controller.dashboardModelObj
                                          .value.upcoming1ItemList.length,
                                      itemBuilder: (context, index) {
  ...
  navigatewithclosecurrentscreen() {
    Get.offNamed(AppRoutes.seeMoreSixScreen);
  }

  navigatetocloseallscreen() {
    Get.offAllNamed(AppRoutes.seeMoreFiveScreen);
  }

  navigateandpassconstdata() {
    Get.offNamed(AppRoutes.seeMoreSevenScreen,
        arguments: {NavigationArgs.consttestdataargument: Admin.passord});
  }
  ...
  onimgclickgoto() {
    Get.offNamed(AppRoutes.detailPageTenScreen, arguments: {
      NavigationArgs.passdataconsttestwithanotherargument: Admin.passord
    });
  }
}
